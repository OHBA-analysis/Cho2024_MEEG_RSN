...
COREG_DIR = os.path.join(BASE_DIR, "scho23/coreg")
ANAT_DIR = os.path.join(DATA_DIR, "public/cc700/mri/pipeline/release004/BIDS_20190411/anat")
...
# SOURCE RECONSTRUCT DATA: COREGISTRATION
if __name__ == "__main__":
    ...
    smri_files = [os.path.join(ANAT_DIR, f"{subject}/anat/{subject}_T1w.nii.gz") for subject in subjects]
